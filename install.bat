...
@powershell -NoProfile -ExecutionPolicy Bypass -Command ". { Install-BoxstarterPackage -PackageName http://boxstarter.org/package/nr/url?https://raw.githubusercontent.com/kelps/repave-scripts/powershell-switch/install.ps1 -DisableReboots }"
